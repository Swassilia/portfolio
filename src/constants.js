...
export const dialoguedata = {
  ...
  Dehors: `Un paysage fort agréable, vous ne trouvez pas ?<img src="ciel.jpg" alt="Dessin" style=all:unset;width:300px;/>`,
  FleurC: `Comme vous pouvez le constater, mon domaine est rempli de fleurs en tout genre. Certaines ont été faites en crochet, comme celle-ci.<img src="fleurC.jpg" alt="rose réalisé en crochet" style=all:unset;width:300px;/>`,
  FleurR: `Vous savez les fleurs magique ce n'est pas donné a tout le monde j'ai la chance d'en avoir trouver il y a longtemps.<img src="fleurinfi.jpg" alt="Reproduction de la fleur magique dans raiponce" style=all:unset;width:300px;/>`,
  ...
  Canette: `Une soif ? Malheureusement, mon distributeur est en panne. Le magicien du village est parti en voyage d'affaires.<img src="distributeur.jpg" alt="Distributeur 3D render 2D fait en blender" style=all:unset;width:300px;/>`,
  ...
  Bibliotheque: `Un peu de lecture ? J'ai réalisé une petite boîte miniature qui met en scène une bibliothèque au coin du feu.<img src="bibliotheque.jpg" alt="Bibliothèque miniature" style=all:unset;width:300px;/>  `,
  Becomtech: `Becomtech ?`,
  Contrat: `?`,
};
